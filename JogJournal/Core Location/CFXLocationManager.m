...
@interface CFXLocationManager () <CLLocationManagerDelegate>

@property (strong, nonatomic) CLLocationManager *locationManager;

@property (nonatomic) BOOL updatingLocations;

// An array of blocks. The blocks will be of type CFXLocationManagerGetLocationUpdateCallback
@property (nonatomic, strong) NSMutableArray *locationUpdateCallbacks;

// An array of blocks. The blocks will be of type CFXLocationManagerGetContinuousLocationUpdatesCallback
...
@implementation CFXLocationManager

+ (CFXLocationManager *)sharedManager
{
    static dispatch_once_t onceToken;
    static CFXLocationManager *sharedInstance = nil;
...
- (void)executeLocationCallbacks
{
    ...
    for (CFXLocationManagerGetLocationUpdateCallback callback in self.locationUpdateCallbacks)
    {
    ...
    for (CFXLocationManagerGetContinuousLocationUpdatesCallback callback in self.continuousLocationUpdatesCallbacks)
    {
        BOOL stop = NO;
    ...
    for (CFXLocationManagerGetContinuousLocationUpdatesCallback callback in callbacksToRemove)
    {
