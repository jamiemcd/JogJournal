//
//  CFXEmailResetPasswordController.m
//  JogJournal
//
...
@interface CFXEmailResetPasswordController () <UITextFieldDelegate>

@property (nonatomic, strong) UILabel *label;
@property (nonatomic, strong) UITextField *emailTextField;
@property (nonatomic, strong) CFXButton *resetPasswordButton;

@property (nonatomic, strong) NSArray *viewConstraints;

@end

@implementation CFXEmailResetPasswordController
...
- (void)createUI
{
    ...
    // ResetPasswordButton
    self.resetPasswordButton = [[CFXButton alloc] init];
...
- (void)resetPasswordButtonTouchDownHandler:(CFXButton *)button
{
    [SVProgressHUD showWithStatus:@"Sending Password Reset Request..." maskType:SVProgressHUDMaskTypeBlack];
    __weak CFXEmailResetPasswordController *weakSelf = self;
    [[CFXParseManager sharedManager] resetPasswordForEmail:self.emailTextField.text withCallback:^(BOOL succeeded, NSError *error) {
        if (succeeded)
        {
