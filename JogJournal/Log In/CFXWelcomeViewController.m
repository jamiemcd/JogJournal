...
@interface CFXWelcomeViewController ()

@property (nonatomic, strong) UIImageView *logoImageView;
@property (nonatomic, strong) UILabel *titleLabel;
@property (nonatomic, strong) CFXButton *facebookConnectButton;
@property (nonatomic, strong) CFXButton *emailSignUpButton;
...
@implementation CFXWelcomeViewController
...
- (void)createUI
{
    ...
    self.facebookConnectButton = [[CFXButton alloc] init];
    ...
    // emailSignUpButton
    self.emailSignUpButton = [[CFXButton alloc] init];
...
- (void)facebookConnectButtonTouchDownHandler:(CFXButton *)button
{
    [[CFXParseManager sharedManager] logInToFacebookWithCallback:^(BOOL succeeded, NSError *error) {
        if (succeeded)
        {
...
- (void)emailSignUpButtonTouchDownHandler:(CFXButton *)button
{
    ...
    dispatch_after(popTime, dispatch_get_main_queue(), ^(void){
        ...
        CFXEmailSignUpViewController *emailSignUpViewController = [[CFXEmailSignUpViewController alloc] init];
...
{
    self.navigationController.navigationBarHidden = NO;
    CFXEmailLogInViewController *emailLogInViewController = [[CFXEmailLogInViewController alloc] init];
