...
@implementation JJEmailLogInViewController
...
- (void)createUI
{
    ...
    // LogInButton
    self.logInButton = [[JJButton alloc] init];
...
{
    JJEmailResetPasswordController *emailResetPasswordController = [[JJEmailResetPasswordController alloc] init];
